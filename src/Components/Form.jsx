...
const Form = () => {
  ...
  const validationName = () => {
    ...
    userName.length < 1 && alert("Enter a valid name and lastname.")
  ...
  const validationEmail = () => {
    ...
    if (userEmail.length < 5) return alert("Enter a valid email.")
  ...
  return (
    <div className="container-formComponent">
      ...
      {validacion ? <h3 className="h3">Thanks for writing to us, {values.name}, we will contact you as soon as possible.</h3> : ""}
      </div>
    </div>
  );
};
